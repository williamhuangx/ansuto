...
CREATE TABLE `trackings` (
    ...
    `origin_city`   VARCHAR(50)   DEFAULT NULL              COMMENT '始发市',
    `destination`   VARCHAR(100)  DEFAULT NULL              COMMENT '目的地',
    `dest_city`     VARCHAR(50)   DEFAULT NULL              COMMENT '目的地市',
    ...
    `pickup_fee`     DECIMAL(10,2) DEFAULT 0                 COMMENT '提货费',
    `special_car_fee` DECIMAL(10,2) DEFAULT 0                COMMENT '专车费',
    `oversize_heavy` VARCHAR(50)   DEFAULT NULL              COMMENT '超长超重',
    `declared_value` DECIMAL(12,2) DEFAULT 0                 COMMENT '保价金额',
